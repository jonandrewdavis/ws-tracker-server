/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 580de65cc9beadd0495f78532096951d)
// Runtime types generated with workerd@1.20260305.0 2025-07-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TrackerObject";
	}
	interface Env {
		SECRET_KEY: string;
		TURN_KEY: string;
		WEBSOCKET_SERVER: DurableObjectNamespace<import("./src/index").TrackerObject>;
	}
}
